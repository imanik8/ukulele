...
class Note {
  constructor(name, xStart) {
    ...
    if (this.noteCode === "C4")
      (this.topNoteY = 270),
        (this.bottomNoteY = 1050),
        (this.noteCubeSSX = 150);
    if (this.noteCode === "D4")
      (this.topNoteY = 220),
        (this.bottomNoteY = 1050),
        (this.noteCubeSSX = 1350);
    if (this.noteCode === "E4")
      (this.topNoteY = 170), (this.bottomNoteY = 900), (this.noteCubeSSX = 300);
    if (this.noteCode === "F4")
      (this.topNoteY = 120), (this.bottomNoteY = 900), (this.noteCubeSSX = 900);
    if (this.noteCode === "G4")
      (this.topNoteY = 70), (this.bottomNoteY = 900), (this.noteCubeSSX = 2100);
    if (this.noteCode === "A4")
      (this.topNoteY = 20), (this.bottomNoteY = 750), (this.noteCubeSSX = 450);
    if (this.name.slice(1, 4) === "A4#")
      (this.topNoteY = 20), (this.bottomNoteY = 750), (this.noteCubeSSX = 1050);
    if (this.noteCode === "B4")
      (this.topNoteY = -30),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 1650);
    if (this.noteCode === "C5")
      (this.topNoteY = -80),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 2250);
    if (this.noteCode === "D5")
      (this.topNoteY = -130),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 3450);
    if (this.noteCode === "E5")
      (this.topNoteY = -180),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 4650);
    if (this.noteCode === "F5")
      (this.topNoteY = -230),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 5250);
    if (this.noteCode === "G5")
      (this.topNoteY = -280),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 6450);
    if (this.noteCode === "A5")
      (this.topNoteY = -330),
        (this.bottomNoteY = 750),
        (this.noteCubeSSX = 7650);
  ...
  Draw() {
    if (this.visible) {
      if (
        this.bottomNoteX <= canvasWidth / 2 &&
        this.bottomNoteX >= canvasWidth / 2 - 112
      ) {
        ctx.drawImage(
          spriteSheets[3],
          this.ssTopSymbolX,
